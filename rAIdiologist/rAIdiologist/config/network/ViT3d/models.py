...
CONFIGS = {
    'ViT3d-V-Net': configs.get_3DReg_config(),
    'ViT3d-Img2Pred': configs.get_3DImg2Pred_config()
}
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        net = ViTVNetImg2Pred(CONFIGS['ViT3d-Img2Pred'], img_size=(320, 320, 32), num_classes=2)
        net = net.cuda()
        pytorch_model_summary.summary(net, torch.rand(1, 2, 320, 320, 32).cuda(),
                                      show_input=True,
