...
rai_options = {
    'networks': {
        ...
        'scdnet'            : SCDenseNet(),
        'resnet3d10'        : get_ResNet3d(10),
        'resnet3d18'        : get_ResNet3d(18),
        'resnet3d34'        : get_ResNet3d(34),
        'resnet3d50'        : get_ResNet3d(50),
        'resnet3d101'       : get_ResNet3d(101),
        'resnet3d152'       : get_ResNet3d(152),
        'resnet3d200'       : get_ResNet3d(200),
